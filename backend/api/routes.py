...
def get_supplier_invoices(
    ...
    for inv in invoices:
        ...
        result.append(SupplierInvoiceResponse(
            ...
            invoice_file_name=inv.invoice_file_name,
            has_file=bool(inv.invoice_file_url),
            notes=inv.notes,
...
def create_supplier_invoice(
    ...
    return SupplierInvoiceResponse(
        ...
        invoice_file_url=db_invoice.invoice_file_url,
        invoice_file_name=db_invoice.invoice_file_name,
        has_file=bool(db_invoice.invoice_file_url),
